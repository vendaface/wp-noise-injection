...
require_once WNI_PLUGIN_DIR . 'includes/class-wni-token-usage.php';
require_once WNI_PLUGIN_DIR . 'includes/class-wni-profiles.php';
...
function wni_activate() {
    ...
    WNI_Profiles::install_defaults();
    WNI_Token_Usage::install_defaults();
    wni_schedule_cron();
}
